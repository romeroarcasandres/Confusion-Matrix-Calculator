...
**[Try it now!](https://romeroarcasandres.github.io/confusion-matrix-calculator/)**

## 💻 Getting Started

### Option 1: Use Online (Recommended)
1. Visit the [live demo](https://romeroarcasandres.github.io/confusion-matrix-calculator/)
